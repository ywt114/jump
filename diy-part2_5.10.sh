...
git clone -b main https://github.com/sbwml/luci-app-alist package/lean/alist
...
# 修改vermagic版本号
# curl -fsSL https://raw.githubusercontent.com/ywt114/diy/main/vermagic-5.10 > vermagic
